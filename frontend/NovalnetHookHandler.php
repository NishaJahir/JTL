...
class NovalnetHookHandler
{
    ...
    {
        if(!empty($_SESSION['novalnet']['seamless_payment_form_response'])) {
            $_SESSION['Zahlungsart']->cName = $_SESSION['Zahlungsart']->angezeigterName['ger'] = $_SESSION['Zahlungsart']->angezeigterName['eng'] = !empty($_SESSION['novalnet']['seamless_payment_form_response']['payment_details']['name']) ? $_SESSION['novalnet']['seamless_payment_form_response']['payment_details']['name'] : 'Novalnet';
        }
    }
...
HTML;
                ...
                $walletOrderDetails = htmlentities($this->novalnetPaymentGateway->getWalletOrderDetails());
                $nnPaymentFormScript .= <<<HTML
                            <fieldset>
...
HTML;
                pq('body')->append($nnPaymentFormScript);
            }
        }
    }
}
